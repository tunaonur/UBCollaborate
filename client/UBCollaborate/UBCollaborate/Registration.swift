...
class Registration: UIViewController, UITextViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        let viewOrigin = CGPoint(x:(registration_clubDescription.frame.origin.x + (registration_clubDescription.frame.size.width/2)), y:(registration_clubDescription.frame.origin.y - (registration_clubDescription.frame.size.height * 8/9)))
        ...
        registration_scrollView.addSubview(cloudView)
        ...
        NSLayoutConstraint.activate([
            ...
            NSLayoutConstraint(item: cloudView, attribute: .top, relatedBy: .equal, toItem: registration_scrollView, attribute: .top, multiplier: 1.0, constant: (registration_tags.frame.origin.y + (registration_tags.frame.origin.y * 3/18))),
