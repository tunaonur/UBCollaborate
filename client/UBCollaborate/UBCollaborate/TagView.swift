...
//  UBCollaborate
//
//  Created by Onur Tuna on 2017-05-16.
...
public protocol TGViewDelegate {
...
open class TagView: UIView {
    ...
    open var delegate: TGViewDelegate?
    ...
    open class func initTagView(_ contents: [String]?, delegate: TGViewDelegate ) -> TagView {
        let bun = Bundle(for: self.classForCoder())
    ...
    open func setupInitialConstraintWRTView(_ view: UITextField) {
        self.mainView = view
